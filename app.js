...
const PRODUCTS = {
  ...
  "Iogurte líquido": {home:1.89, yield:1000, unit:"g", label:"1000 g", status:"validado", source:"Receita-base fornecida: rendimento 1000 g; 1000 g leite meio-gordo + 50 g açúcar + 2 limões. Custo de 1,89 € confirmado em 20/09/2026 com referência conservadora de 1 embalagem de leite, 50 g de açúcar e 2 limões. Comparação final mantida em gramas para não assumir equivalência g↔ml.", periods:["dia","semana","mês"]},
  ...
  "Pão alentejano": {home:0.47, yield:750, unit:"g", label:"750 g", status:"validado", source:"Cookidoo · Pão alentejano (750 g). Custo recorrente validado: 590 g farinha T65 + 5 g levedura fresca + sal; água sem custo de supermercado; farinha q.b. não quantificada. Levedura fresca: Auchan 2 × 25 g, 0,60 € (12 €/kg), observada em 20/09/2026.", periods:["semana","mês"]}
};
...
function defaultPrices(){
  return {
    ...
    references:{
      ...
      "Pão alentejano":[
        {store:"Continente",brand:"Pão Alentejano Massa Mãe",price:3.49,pack:1000,unit:"g",format:"preço por kg",note:"Referência comercial de pão alentejano com massa-mãe observada em 20/09/2026.",validation:"confirmada"},
